...
goog.addDependency("../ident.js", ['ss.ident'], ['ss.utils', 'cljs.core', 'clojure.browser.dom', 'ss.debug', 'ss.ui', 'clojure.string', 'ss.dom_helpers', 'goog.style', 'ss.state', 'goog.events', 'ss.ss_utils']);
...
goog.addDependency("../streamscapes.js", ['ss.streamscapes'], ['ss.utils', 'cljs.core', 'clojure.browser.dom', 'ss.debug', 'ss.ui', 'clojure.string', 'ss.droplet', 'ss.ceptr', 'ss.dom_helpers', 'ss.state']);
goog.addDependency("../auth.js", ['ss.auth'], ['ss.utils', 'cljs.core', 'goog.ui.Prompt', 'ss.debug', 'ss.ui', 'ss.ident', 'clojure.string', 'ss.ceptr', 'ss.dom_helpers', 'goog.ui.Dialog', 'ss.state', 'ss.streamscapes', 'ss.ss_utils']);

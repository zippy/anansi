...
(deftest droplet
  (let [r (receptor :some-parent nil)
        o (make-receptor droplet-def r "some-id" "from-addr" "to-addr" :some-aspect {:part1 "address of part1 grammar"} {:part1 "part1 content"})]
    (testing "contents"
    ...
    (testing "droplets with auto-id creation"
      (let [d (make-receptor droplet-def r nil "from-addr" "to-addr" :some-aspect {:part1 "address of part1 grammar"} {:part1 "part1 content"})]
